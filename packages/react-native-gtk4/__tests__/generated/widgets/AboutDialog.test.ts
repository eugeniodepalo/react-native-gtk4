import { AboutDialog } from "@/generated/widgets.js"
import Gtk from "@/generated/girs/node-gtk-4.0.js"
import Gdk from "@/generated/girs/node-gdk-4.0.js"

describe("AboutDialog", () => {
  let widget: AboutDialog
  ...
  test("should set authors", () => {
    ...
    expect(widget.node.setAuthors).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should set logo", () => {
    ...
    expect(widget.node.setLogo).toHaveBeenCalledWith(newValue)
  })

  test("should set logoIconName", () => {
    const newValue = "Some String"
    widget.set("logoIconName", newValue)
    expect(widget.node.setLogoIconName).toHaveBeenCalledWith(newValue)
  })

  test("should set programName", () => {
    const newValue = "Some String"
    widget.set("programName", newValue)
    expect(widget.node.setProgramName).toHaveBeenCalledWith(newValue)
  })

  test("should set systemInformation", () => {
    const newValue = "Some String"
    widget.set("systemInformation", newValue)
    expect(widget.node.setSystemInformation).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should set websiteLabel", () => {
    ...
    expect(widget.node.setWebsiteLabel).toHaveBeenCalledWith(newValue)
  })

  test("should set wrapLicense", () => {
    const newValue = true
    widget.set("wrapLicense", newValue)
    expect(widget.node.setWrapLicense).toHaveBeenCalledWith(newValue)
  })
