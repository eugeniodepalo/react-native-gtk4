import { AspectFrame } from "@/generated/widgets.js"
import Gtk from "@/generated/girs/node-gtk-4.0.js"

describe("AspectFrame", () => {
  let widget: AspectFrame
  ...
  test("should append child", () => {
    const child = new AspectFrame({}, AspectFrame.createNode())
  ...
  test("should insert child before", () => {
    const child = new AspectFrame({}, AspectFrame.createNode())
    const sibling = new AspectFrame({}, AspectFrame.createNode())
    widget.appendChild(child)
