...
describe("Calendar", () => {
  ...
  test("should connect onDaySelected", () => {
    ...
    handler()
    expect(node.on).toHaveBeenCalledWith("day-selected", expect.any(Function))
  ...
  test("should connect onNextMonth", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("next-month", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNextYear", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("next-year", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPrevMonth", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("prev-month", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPrevYear", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("prev-year", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyDay", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(node.on).toHaveBeenCalledWith("notify::day", expect.any(Function))
  })
  ...
  test("should connect onNotifyMonth", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(node.on).toHaveBeenCalledWith("notify::month", expect.any(Function))
  })
  ...
  test("should connect onNotifyYear", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(node.on).toHaveBeenCalledWith("notify::year", expect.any(Function))
  })
