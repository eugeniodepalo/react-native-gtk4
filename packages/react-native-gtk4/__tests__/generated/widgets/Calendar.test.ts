import { Calendar } from "@/generated/widgets.js"
...
describe("Calendar", () => {
  ...
  test("should set day", () => {
    ...
    expect(widget.node.setDay).toHaveBeenCalledWith(newValue)
  })

  test("should set month", () => {
    const newValue = 1
    widget.set("month", newValue)
    expect(widget.node.setMonth).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should set year", () => {
    ...
    expect(widget.node.setYear).toHaveBeenCalledWith(newValue)
  })
