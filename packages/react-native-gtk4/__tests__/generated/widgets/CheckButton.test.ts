import { CheckButton } from "@/generated/widgets.js"
import Gtk from "@/generated/girs/node-gtk-4.0.js"
import GLib from "@/generated/girs/node-glib-2.0.js"

describe("CheckButton", () => {
  let widget: CheckButton
  ...
  test("should set actionTarget", () => {
    ...
    expect(widget.node.setActionTarget).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should append child", () => {
    const child = new CheckButton({}, CheckButton.createNode())
  ...
  test("should insert child before", () => {
    const child = new CheckButton({}, CheckButton.createNode())
    const sibling = new CheckButton({}, CheckButton.createNode())
    widget.appendChild(child)
