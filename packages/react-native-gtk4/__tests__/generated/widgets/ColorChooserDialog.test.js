import { ColorChooserDialog } from "../../../src/generated/widgets.js"
...
describe("ColorChooserDialog", () => {
  ...
  beforeEach(() => {
    node = new Gtk.ColorChooserDialog()
    Gtk.ColorChooserDialog.mockImplementation(() => node)
  ...
  test("should set showEditor", () => {
    ...
    expect(node.showEditor).toBe(newValue)
  })
  ...
  test("should set useAlpha", () => {
    ...
    expect(node.setUseAlpha).toHaveBeenCalledWith(newValue)
  })
