import { ComboBox } from "@/generated/widgets.js"
...
describe("ComboBox", () => {
  ...
  beforeEach(() => {
    widget = new ComboBox({}, ComboBox.createNode({ hasEntry: true }))
  })
  ...
  test("should append child", () => {
    const child = new ComboBox({}, ComboBox.createNode())
  ...
  test("should insert child before", () => {
    const child = new ComboBox({}, ComboBox.createNode())
    const sibling = new ComboBox({}, ComboBox.createNode())
    widget.appendChild(child)
