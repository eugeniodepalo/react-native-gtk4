import { FlowBoxChild } from "@/generated/widgets.js"
import Gtk from "@/generated/girs/node-gtk-4.0.js"

describe("FlowBoxChild", () => {
  let widget: FlowBoxChild
  ...
  test("should append child", () => {
    const child = new FlowBoxChild({}, FlowBoxChild.createNode())
  ...
  test("should insert child before", () => {
    const child = new FlowBoxChild({}, FlowBoxChild.createNode())
    const sibling = new FlowBoxChild({}, FlowBoxChild.createNode())
    widget.appendChild(child)
