...
describe("IconView", () => {
  ...
  beforeEach(() => {
    node = new Gtk.IconView()
    Gtk.IconView.mockImplementation(() => node)
    widget = new IconView({})
  })
  ...
  test("should set columns", () => {
    ...
    expect(node.setColumns).toHaveBeenCalledWith(newValue)
  })

  test("should set itemOrientation", () => {
    const newValue = Gtk.Orientation.HORIZONTAL
    widget.set("itemOrientation", newValue)
    expect(node.setItemOrientation).toHaveBeenCalledWith(newValue)
  })

  test("should set itemPadding", () => {
    const newValue = 1
    widget.set("itemPadding", newValue)
    expect(node.setItemPadding).toHaveBeenCalledWith(newValue)
  })

  test("should set itemWidth", () => {
    const newValue = 1
    widget.set("itemWidth", newValue)
    expect(node.setItemWidth).toHaveBeenCalledWith(newValue)
  })

  test("should set margin", () => {
    const newValue = 1
    widget.set("margin", newValue)
    expect(node.setMargin).toHaveBeenCalledWith(newValue)
  })

  test("should set markupColumn", () => {
    const newValue = 1
    widget.set("markupColumn", newValue)
    expect(node.setMarkupColumn).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should set pixbufColumn", () => {
    ...
    expect(node.setPixbufColumn).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should set textColumn", () => {
    ...
    expect(node.setTextColumn).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should connect onItemActivated", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("item-activated", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyMargin", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(node.on).toHaveBeenCalledWith("notify::margin", expect.any(Function))
  })
