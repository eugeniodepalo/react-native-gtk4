import { ListBoxRow } from "@/generated/widgets.js"
import Gtk from "@/generated/girs/node-gtk-4.0.js"
import GLib from "@/generated/girs/node-glib-2.0.js"

describe("ListBoxRow", () => {
  let widget: ListBoxRow
  ...
  test("should append child", () => {
    const child = new ListBoxRow({}, ListBoxRow.createNode())
  ...
  test("should insert child before", () => {
    const child = new ListBoxRow({}, ListBoxRow.createNode())
    const sibling = new ListBoxRow({}, ListBoxRow.createNode())
    widget.appendChild(child)
