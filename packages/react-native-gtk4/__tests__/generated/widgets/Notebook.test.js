...
describe("Notebook", () => {
  ...
  test("should connect onCreateWindow", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("create-window", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onFocusTab", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("focus-tab", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onMoveFocusOut", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("move-focus-out", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPageAdded", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("page-added", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPageRemoved", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("page-removed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPageReordered", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("page-reordered", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onReorderTab", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("reorder-tab", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSelectPage", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("select-page", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSwitchPage", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("switch-page", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyPage", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(node.on).toHaveBeenCalledWith("notify::page", expect.any(Function))
  })
  ...
  test("should connect onNotifyPages", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(node.on).toHaveBeenCalledWith("notify::pages", expect.any(Function))
  })
