import { Picture } from "@/generated/widgets.js"
...
describe("Picture", () => {
  ...
  test("should set alternativeText", () => {
    ...
    expect(widget.node.setAlternativeText).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should set contentFit", () => {
    ...
    expect(widget.node.setContentFit).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should set keepAspectRatio", () => {
    ...
    expect(widget.node.setKeepAspectRatio).toHaveBeenCalledWith(newValue)
  })
