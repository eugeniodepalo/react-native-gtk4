...
describe("ScrolledWindow", () => {
  ...
  test("should connect onEdgeOvershot", () => {
    ...
    handler()
    expect(node.on).toHaveBeenCalledWith("edge-overshot", expect.any(Function))
  ...
  test("should connect onEdgeReached", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("edge-reached", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onScrollChild", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("scroll-child", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
