import { ScrolledWindow } from "@/generated/widgets.js"
...
describe("ScrolledWindow", () => {
  ...
  test("should append child", () => {
    const child = new ScrolledWindow({}, ScrolledWindow.createNode())
  ...
  test("should insert child before", () => {
    const child = new ScrolledWindow({}, ScrolledWindow.createNode())
    const sibling = new ScrolledWindow({}, ScrolledWindow.createNode())
    widget.appendChild(child)
