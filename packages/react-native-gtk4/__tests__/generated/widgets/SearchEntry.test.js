...
describe("SearchEntry", () => {
  ...
  test("should set searchDelay", () => {
    ...
    expect(node.setSearchDelay).toHaveBeenCalledWith(newValue)
  })
  ...
  test("should connect onNextMatch", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("next-match", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onPreviousMatch", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("previous-match", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSearchChanged", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("search-changed", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onSearchStarted", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("search-started", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onStopSearch", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("stop-search", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
