...
describe("SpinButton", () => {
  ...
  test("should connect onChangeValue", () => {
    ...
    handler()
    expect(node.on).toHaveBeenCalledWith("change-value", expect.any(Function))
  ...
  test("should connect onOutput", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("output", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onWrapped", () => {
    ...
    expect(handler).toBeDefined()
    handler()
    expect(node.on).toHaveBeenCalledWith("wrapped", expect.any(Function))
    expect(callback).toHaveBeenCalled()
  })
  ...
  test("should connect onNotifyWrap", () => {
    ...
    handler()
    expect(callback).toHaveBeenCalled()
    expect(node.on).toHaveBeenCalledWith("notify::wrap", expect.any(Function))
  })
